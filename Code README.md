...
=======
# DETR-improvements
The objective of this project is to implement improvements to the DETR model to improve either it's accuracy, training efficiency, or reduce the computational complexity.
>>>>>>> origin/main
